...
**Paso 1.** Crea los elementos necesarios.
...
## Resultado esperado
El query ejecutado sobre la tabla `pg_index` mostrará las siguientes columnas de resultados.
